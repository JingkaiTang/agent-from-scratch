package com.github.agent.demo06;

import com.github.agent.demo06.agent.AgentConfig;
import com.github.agent.demo06.agent.AgentService;
import com.github.agent.demo06.ui.ChatWindow;
...
public class Demo06App extends Application {
    ...
    private static final Logger log = LoggerFactory.getLogger(Demo06App.class);
