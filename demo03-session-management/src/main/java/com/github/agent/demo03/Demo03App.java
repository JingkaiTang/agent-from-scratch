package com.github.agent.demo03;

import com.github.agent.demo03.agent.AgentConfig;
import com.github.agent.demo03.agent.AgentService;
import com.github.agent.demo03.ui.ChatWindow;
...
/**
 * Demo03 入口 —— JavaFX Application 启动类。
 * <p>
 ...
 * </pre>
 */
public class Demo03App extends Application {

    private static final Logger log = LoggerFactory.getLogger(Demo03App.class);
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Agent From Scratch - 会话管理");
        // 设置窗口图标（多尺寸适配）
