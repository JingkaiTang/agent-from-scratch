...
| **demo02** ✅ | GUI Agent | JavaFX 图形界面、SSE 流式响应、Agent 回调机制 |
| **demo03** ✅ | Session Management | 会话建模、JSON 持久化、多会话切换、侧边栏 GUI |
| **demo04** ✅ | Memory Management | 短期记忆、滑动窗口、LLM 摘要压缩、Token 估算 |
| **demo05** ✅ | Long-Term Memory | 跨会话长期记忆、Markdown 持久化、LLM 提取 + grep 检索 |
| **demo06** ✅ | Skills | 元数据索引、按需加载、自描述指令包 |
| demo07 | RAG Agent | 检索增强生成、知识库集成 |
| demo08 | Streaming | 流式输出、实时反馈 |
