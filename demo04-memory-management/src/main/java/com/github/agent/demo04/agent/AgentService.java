package com.github.agent.demo04.agent;

import com.github.agent.demo04.core.AgentCallback;
import com.github.agent.demo04.core.AgentLoop;
import com.github.agent.demo04.config.AppConfigLoader;
import com.github.agent.demo04.llm.LLMClient;
import com.github.agent.demo04.memory.ConversationCompactor;
import com.github.agent.demo04.memory.MemoryConfig;
import com.github.agent.demo04.memory.MemoryManager;
import com.github.agent.demo04.memory.TokenCounter;
import com.github.agent.demo04.model.ChatMessage;
import com.github.agent.demo04.session.Session;
import com.github.agent.demo04.session.SessionChangeListener;
import com.github.agent.demo04.session.SessionManager;
import com.github.agent.demo04.session.SessionStore;
import com.github.agent.demo04.tool.ToolRegistry;
import com.github.agent.demo04.tool.impl.ExecTool;
 ...
 * 在 Demo03 基础上新增：
 * <ul>
 *   <li>从 {@code ~/.afs/config.json} 加载记忆管理配置</li>
 *   <li>创建 {@link MemoryManager} 并注入 AgentLoop，启用短期记忆管理</li>
 * </ul>
 * <p>
 * 职责：
 * <ul>
